				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">Manage Booking's</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							<li><a href="index.php">Dashboard</a></li>
							<li class="active"><span>Manage Booking's</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
											...
											<table id="example" class="table table-hover display  pb-30" >
												...
												<tbody>
                                                    <?php
														...
														{ $aa = $_GET['uorder']; 
															$cat=mysqli_query($con,"select * from `book` WHERE c_email='$aa' ORDER BY sno DESC");
															$i=1;
													...
													{	
														$type = $_GET['type'];
														$cat=mysqli_query($con,"select * from `book` WHERE ctype='$type' Order By sno desc");
														$i=1;
														while($row=mysqli_fetch_array($cat))
															{
													?>
													...
													{
														$cat=mysqli_query($con,"select * from `book` Order By sno desc");
														$i=1;
														while($row=mysqli_fetch_array($cat))
														{
