...
include("header.php");
$cat=mysqli_query($con,"select * from `user` WHERE status='0' ORDER BY sno DESC");
											...
											<table id="example" class="table table-hover display  pb-30" >
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<a class='edit btn btn-sm btn-primary' href='./order?uorder=<?php echo $row['email']; ?>' >Booking Detail</a>
														</td>
